        ...
        <div>
            ...
            <div className="mx-auto flex flex-wrap justify-center w-5/6 mt-32 content-inside pb-4">
                <div className="flex flex-col justify-center items-center w-min-[30rem]">
                    <div className="relative w-[30rem] h-[25rem] mb-14">
                        <Image src="/assets/BoxReference/probka.webp"
                               alt="Logo Planko"
                               layout="fill"
                               objectFit="contain"
                        />
                        <div className="top-40 relative text-white font-sans bg-gray-800 bg-opacity-50">
                            <h1 className="text-center font-normal text-3xl font-light uppercase">
                                Napisz do nas w celu zamówienia próbki
                            </h1>
                        </div>
                    </div>
                </div>
